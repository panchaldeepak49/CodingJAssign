  ...
  return (
    ...
    <div className=' w-[100%] h-auto bg-gradient-to-b from-[#0196F9] via-[#2B95ED] to-[#14CBD5] pb-24 '> 
        <div className='relative flex justify-center'>
          ...
          <img src={javaImg} className='absolute w-[6%] left-0 h-auto' />
        </div> 
        ...
        <div className='relative mt-10'>
           <img src={nodeImg} className='absolute w-[6%] left-[17%] h-auto' /> 
           <img src={flutterImg} className='absolute w-[8%] top-[10%] right-[20%] h-auto' /> 
        </div>
