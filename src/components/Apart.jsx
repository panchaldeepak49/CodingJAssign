...
const Apart = () => {
  return (
    ...
    <div className='mt-2 h-auto sm:h-[120vh] lg:h-[95vh] bg-[#2B95ED]'>
        ...
        <img src={ornamentImg} className='max-450:w-[8%] w-[5%] md:w-[3%]'/>
        </div>
        ...
        <div className='py-10 px-10 sm:px-44 grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-10'>
            ...
            <div className='max-450:py-1 sm:h-32 md:h-52 bg-white w-[100%] rounded-lg'> 
               ...
               <img src={graduationImg} className='max-450:pl-1 py-0 w-[20%] sm:w-[30%] md:w-[40%]'/>
               <div className='px-4'>
            ...
            <div className='max-450:py-1 sm:h-32 md:h-52 bg-white w-[100%] rounded-lg'> 
               ...
               <img src={aiImg} className='max-450:pl-1 w-[20%] sm:w-[30%] md:w-[40%]'/>
               <div className='px-4'>
            ...
            <div className='max-450:py-1 sm:h-32 md:h-52 bg-white w-[100%] rounded-lg'> 
                <img src={appCodingImg} className='max-450:pl-1 w-[20%] sm:w-[30%] md:w-[40%]'/>
                <div className='px-4'>
            ...
            <div className='max-450:py-1 sm:h-32 md:h-52 bg-white w-[100%] rounded-lg'> 
                <img src={openBookImg} className='max-450:pl-1 w-[20%] sm:w-[30%] md:w-[40%]'/>
                <div className='px-4'>
            ...
            <div className='max-450:py-1 sm:h-32 md:h-52 bg-white w-[100%] rounded-lg'> 
                <img src={recordedLectImg} className='max-450:pl-1 w-[20%] sm:w-[30%] md:w-[40%]'/>
                <div className='px-4'>
            ...
            <div className='max-450:py-1 sm:h-32 md:h-52 bg-white w-[100%] rounded-lg'> 
                <img src={kindleImg} className='max-450:pl-1 w-[20%] sm:w-[30%] md:w-[40%]'/>
                <div className='px-4'>
